...
/** RemotingApi is an interface used to launch a build macro that sets up your Haxe remoting API context.
...
you wish to share with your remoting context.  Eg:
	...
	class MainApi implements ufcommon.remoting.RemotingApi {
